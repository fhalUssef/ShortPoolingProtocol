...
3. the server after each 3 second it increase all job progress by 10% then if a job progress reached 100% it gonna be removed from not yet finished and will be added  to Map of the completed Jobs .  
